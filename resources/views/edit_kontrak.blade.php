    ...
    <div class="container-fluid">
		...
		<div class="row heading-bg">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			    <h5 class="txt-dark">Ubah Data Kontrak</h5>
			</div>
			<!-- Breadcrumb -->
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active"><span>Ubah Data Kontrak</span></li>
				</ol>
			</div>
			<!-- /Breadcrumb -->
		</div>
                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ url('updatek/'.$kontrak->id) }}" enctype="multipart/form-data">
                                    @method('post')
                                    @csrf
                                    <div class="form-group col-md-6">
                                        <label class="control-label mb-10 text-left">Durasi</label>
                                        <input type="text" class="form-control @error('durasi')is-invalid @enderror" name="durasi" value="{{$kontrak->durasi}}" placeholder="Masukan Durasi Kerja">
                                        @error('durasi')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('gaji')is-invalid @enderror" name="gaji" value="{{$kontrak->gaji}}" placeholder="Masukan Gaji">
                                        @error('gaji')
                                            <div class="invalid-feedback text-danger mt-5" id="validationServerUsernameFeedback">
                                            {{ $message }}
                                            </div>
