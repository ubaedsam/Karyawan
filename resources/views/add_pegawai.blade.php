    ...
    <div class="container-fluid">
		...
		<div class="row heading-bg">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			    <h5 class="txt-dark">Tambah Data Pegawai</h5>
			</div>
			<!-- Breadcrumb -->
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active"><span>Tambah Data Pegawai</span></li>
				</ol>
			</div>
			<!-- /Breadcrumb -->
		</div>
                ...
                <div class="panel panel-default card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ route('pegawai.tambah') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('ttl')is-invalid @enderror" name="ttl">
                                        @error('ttl')
                                            <div class="invalid-feedback text-danger mt-5" id="validationServerUsernameFeedback">
                                            {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('usia')is-invalid @enderror" name="usia" placeholder="Usia Pegawai">
                                        @error('usia')
                                            <div class="invalid-feedback text-danger mt-5" id="validationServerUsernameFeedback">
                                            {{ $message }}
                                            </div>
